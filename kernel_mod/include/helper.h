...
struct NATRecord *matchNATRule(unsigned int sip, unsigned int dip,
                               int *isMatch);
unsigned short getNewNATPort(struct NATRecord rule);
struct NATRecord genNATRecord(unsigned int preIP, unsigned int afterIP,
                              unsigned short prePort, unsigned short afterPort);
